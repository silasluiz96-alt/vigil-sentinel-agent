...
DADOS_TREINO = [
    # Decisores claros — alto potencial
    ...
    [0.3,  0.6,  0.45, 0.9,  0.85, 0.5, 0.0, 1],  # fazendo MBA em Gestão de TI
...
_X = np.array([d[:6] for d in DADOS_TREINO])
_y = np.array([d[6]  for d in DADOS_TREINO])
